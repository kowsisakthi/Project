...
export default function TrueFalse(props) {
  // console.log("IIIIIIIIIIIIIIII "+props.optionC);
  // const changeOptionCHandler = () => {
  //  const updatedValue="null";
  //   props.changeOptionCHandler(updatedValue);
  //   // alert("Hi")
  // };

  // const changeOptionDHandler = (value) => {
  //   // Set the value to null if it is an empty string
  //   const updatedValue = value.trim() === "" ? null : value;
  //   // Call the prop function to update the state in the parent component
  //   props.changeOptionDHandler(updatedValue);
  // };

  // const changeOptionEHandler = (value) => {
  //   // Set the value to null if it is an empty string
  //   const updatedValue = value.trim() === "" ? null : value;
  //   // Call the prop function to update the state in the parent component
  //   props.changeOptionEHandler(updatedValue);
  // };
  return (
    <>
